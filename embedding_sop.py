...
class GMPEmbedder:
    ...
    def create_chroma_db(self, 
                        ...
                        collection_name: str = "sop_documents_semantic", 
                        persist_directory: str = "./chroma_db_sop") -> Chroma:
    ...
    def process_jsonl_to_chroma(self, 
                               jsonl_path: str = "/Users/song/Desktop/workspace/final/rag/embedding/semantic_chunks_sop.jsonl",
                               collection_name: str = "sop_documents_semantic", 
                               persist_directory: str = "./chroma_db_sop"):
