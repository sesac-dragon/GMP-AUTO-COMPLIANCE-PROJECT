...
def process_zip_file_parallel(zip_path: str = '', 
                             output_path: str = 'semantic_chunks_sop_parallel.jsonl',
                             model_name: str = "jhgan/ko-sroberta-multitask",
                             device: str = 'cpu',  # 병렬처리시 'cpu' 권장
                             breakpoint_threshold_type: str = "percentile",
                             breakpoint_threshold_amount: int = 70,
...
if __name__ == "__main__":
    ...
    process_zip_file_semantic(
        zip_path="/Users/song/Desktop/workspace/final/rag/SOP_SAMPLE(SPK).zip",
        output_path="semantic_chunks_sop.jsonl",
